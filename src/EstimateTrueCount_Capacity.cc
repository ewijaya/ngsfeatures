...
int main(int arg_count, char* arg_vec[]) {
    ...
    */
    ...
    string Capacity = arg_vec[2];
    string baseName = GetBaseNameFromFilename(qualFileName);
    string pathName = GetPathNameFromFilename(qualFileName);

    string nbFileName = pathName + baseName + "_" + Capacity + ".nb";
    string propFileName = pathName + baseName + "_" + Capacity + ".prop";
    string nbQualFileName = pathName + baseName + "_" + Capacity + ".nbq";

    // cout << nbFileName << endl;
    // cout << propFileName << endl;
    // cout << nbQualFileName << endl;
