 ...
 *  Last Modified: $Date: 2008/03/02 22:20:42 $
 *
 *  Purpose: try code involving SerialNumbersForStrings
 */
#include <iostream>
#include "../SerialNumbersForStrings_accessCounting.hh"

namespace cbrc{
  void trySerialNumberString_accessCounting(){
    SerialNumbersForStrings_accessCounting<unsigned char> sns;
...
int main(){
  cbrc::trySerialNumberString_accessCounting();
  return 1;
}
